package com.reanimatetdexample.RNModuleTransparent;
...
public class TransparentModule extends ReactContextBaseJavaModule {
    public static final String REACT_NAME = "RNModuleTransparent";
    ...
    public TransparentModule(@Nullable ReactApplicationContext reactContext) {
        super(reactContext);
    }
